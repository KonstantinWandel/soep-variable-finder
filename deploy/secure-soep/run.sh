#!/usr/bin/env bash
# Build + run the SOEP-only GeoLAB stack (backend + Caddy frontend + cloudflare
...
echo "SOEP stack up. User: $GEOLAB_BASIC_AUTH_USER  Password: $GEOLAB_BASIC_AUTH_PASSWORD"
